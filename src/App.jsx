...
function App() {
  ...
  return (
    <BrowserRouter>
      <AppProvider>
        <nav className='bg-gradient-to-r from-indigo-600 to-blue-500 text-white px-6 py-4 shadow-md flex justify-between items-center '>
            <Link onClick={()=>setSelectedTab("Home")} to="/" className={selectedTab==="Home"?" px-4 py-4 bg-blue-500 border-blue-500 text-blue-400 w-36 text-center border rounded-lg bg-opacity-25 text-xl  ":"px-4 py-4 w-36 text-center hover:hover:bg-white hover:text-blue-600 px-3 py-1 rounded-md transition"}>Home</Link>
