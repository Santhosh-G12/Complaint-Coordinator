...
1. Try to understand the complaint in depth because misinterpreting the issue may cause serious problems for our team.
2. Identify as many distinct issues as possible from the complaint description.
3. Use the selected product to filter relevant event types for mapping.

{
  ...
  "Mapped Codes": "Map the reported issues to the predefined codes relevant to the selected product. Return an array of matched codes. If no match is found, return an empty array."
}

Selected Product:
${selectedproduct}

Filtered Event Types ;${filteredevent_types}
...
`;
    ...
    try{
      ...
      console.log("Generated prompt:", JSON.stringify(prompt));
